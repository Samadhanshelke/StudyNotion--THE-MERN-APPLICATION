...
function CodeBlocks({position,heading,subheading,ctabtn1,ctabtn2,codeblock,backgroundGradient,codeColor}) {
  return (
    <div className={`flex ${position} my-20  justify-between gap-10 flex-col lg:gap-10`}>
          ...
          {/* section 2 */}
          <div className='h-fit lg:w-[40%] flex flex-row text-[10px] sm:text-[13px] lg:text-[14px] justify-start relative border-2 border-richblack-700 p-2 '>
          ...
          <div className={`w-[90%] lg:w-[500px]  flex flex-col gap-2 font-bold font-mono pr-2 ${codeColor} `}>
               <TypeAnimation
