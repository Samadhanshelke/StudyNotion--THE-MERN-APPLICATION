...
export default function CoursesTable({ courses, setCourses,timeDuration,setTimeDuration }) {
  ...
  return (
    ...
    <>
      <Table className="rounded-xl border border-richblack-800 text-richblack-100 custom-class ">
        <Thead>
          <Tr className="flex gap-x-10   rounded-t-md border-b border-b-richblack-800 px-6 py-2 text-richblack-100 custom-text-color">
            <Th className="flex-1 text-left text-sm font-medium uppercase text-richblack-100 custom-text-color">
              Courses
            </Th>
